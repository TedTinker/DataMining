...
```{r whiteTest,message=FALSE,warning=FALSE} 
...
```
```{r bluelog,include=FALSE,message=FALSE,warning=FALSE}
...
```
```{r redlog,include=FALSE,message=FALSE,warning=FALSE}
...
```
```{r blacklog,include=FALSE,message=FALSE,warning=FALSE}
...
```{r greenlog,include=FALSE,message=FALSE,warning=FALSE}
...
Comparing five AUC values of logistic models, these are not huge, but they are not discouragingly small. We proceed to made our final model using the outputs of the previous models:

```{r guesses2,warning=FALSE,message=FALSE}
set.seed(1)
...
```{r finallog,warning=FALSE,message=FALSE}
library(nnet)
set.seed(1)
